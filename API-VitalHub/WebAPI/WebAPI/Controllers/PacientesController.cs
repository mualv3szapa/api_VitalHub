    ...
    public class PacientesController : ControllerBase
    {
        ...
        public async Task<IActionResult> Post([FromForm] PacienteViewModel pacienteModel)
        {
            try
            {
                ...
                var containerName = "conteinervitalhubgp11murilo";

                // define a string de conecao
                var connectionString = "DefaultEndpointsProtocol=https;AccountName=blobvitalhubgp11murilo;AccountKey=6Ynt8S0w2g3sXZSqeNqDIaHuY5o1T7/uvR/lyH0k/r2fo0wtsdRkMlXFiyVW0fik0Q+h4kf+Ep2++AStzG4E/Q==;EndpointSuffix=core.windows.net";
